...
public class GameV3 {
    public static void main(String[] args){
        ...
        apresetnarDesafio(n, jogo1.tentativas);
        jogar(sc, n, jogo1.tentativas, jogo1.numeroSorteado);
        finalizarJogo(jogo1.numeroSorteado);
    }

    static void finalizarJogo(int numeroSorteado) {
        System.out.println("O número era: " + numeroSorteado);
        System.out.println("Fim de Jogo!");
    }

    static void jogar(Scanner leitor, String nome, int tentativas, int numeroSorteado) {
        while (tentativas > 0) {
